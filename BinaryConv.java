...
//This was the class I used to create objects when someone wanted to convert binary to integers.
public class BinaryConv {
	...
	public String binAdd2 = "";
		...
		//This was the constructor for the Binary Convertor object, which starts off by asking for the input in binary as a String via a Input Dialog box
	    public BinaryConv() {
	    s=JOptionPane.showInputDialog(null, "Input binary (if missing numbers, will be shifted to right- if too many, first numbers will be cut off) up to 32 bits");
//	   
	    if(s.length() > 32) {
